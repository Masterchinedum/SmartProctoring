...
and server requests keep 3 frames. It gives about 3× the capacity per server (PERFORMANCE §6). Measured with the
same realistic swap and long genuine scenarios (`E2E_SAMPLING=balanced`):
